...
HD_PWD='D:/FPGA-MAZE-2023DD-final/FPGA_MAZE_vivado/FPGA_MAZE_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log create_map.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source create_map.tcl
